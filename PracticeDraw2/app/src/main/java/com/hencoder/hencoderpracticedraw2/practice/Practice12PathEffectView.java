...
public class Practice12PathEffectView extends View {
...

    {
        ...
        discretePathEffect = new DiscretePathEffect(30, 20);
        dashPathEffect = new DashPathEffect(new float[]{20, 10, 5, 10}, 20);
        Path dashPath = new Path();
        dashPath.lineTo(20, -30);
        dashPath.lineTo(40, 0);
        dashPath.close();
        pathDashPathEffect = new PathDashPathEffect(dashPath,50,20, PathDashPathEffect.Style.MORPH);
