...
public class Practice14MaskFilterView extends View {
...

    {
        ...
        blurMaskFilter1 = new BlurMaskFilter(200, BlurMaskFilter.Blur.NORMAL);
        blurMaskFilter2 = new BlurMaskFilter(200, BlurMaskFilter.Blur.INNER);
        blurMaskFilter3 = new BlurMaskFilter(200, BlurMaskFilter.Blur.OUTER);
        blurMaskFilter4 = new BlurMaskFilter(200, BlurMaskFilter.Blur.SOLID);
    }
