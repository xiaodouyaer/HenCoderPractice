...
public class Practice02BeforeOnDrawView extends AppCompatTextView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        bounds.left = layout.getLineLeft(layout.getLineCount() - 5);
        bounds.right = layout.getLineRight(layout.getLineCount() - 5);
        bounds.top = layout.getLineTop(layout.getLineCount() - 5);
        bounds.bottom = layout.getLineBottom(layout.getLineCount() - 5);
        canvas.drawRect(bounds, paint);
