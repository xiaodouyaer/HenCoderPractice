    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Keyframe one = Keyframe.ofFloat(0, 0);
                Keyframe two = Keyframe.ofFloat(0.5f, 100);
                Keyframe three = Keyframe.ofFloat(1, 80);

                PropertyValuesHolder holder = PropertyValuesHolder.ofKeyframe("progress", one, two, three);
